...
addon_info = AddonInfo(
	...
	addon_name="keyRemapper",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("Key Remapper"),
	# Add-on description
...
Provides functionality to map one key to another and execute the mapped keys."""),
	...
	addon_url="https://github.com/audioses/keyRemapper",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/audioses/keyRemapper",
...
pythonSources: list[str] = ["globalPlugins/keyRemapper/*.py"]
